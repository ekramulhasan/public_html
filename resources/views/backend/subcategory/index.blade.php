                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li><a class="dropdown-item" href="{{ route('subcategory.edit', $value->slug) }}"> <i class="fa-regular fa-pen-to-square"></i> Edit</a></li>
                                  <li>

                                    <form action="{{ route('subcategory.destroy', $value->slug) }}" method="post">
                                        @csrf
                                        @method('DELETE')
