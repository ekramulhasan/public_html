        ...
        <div class="table-responsive my-2">
            ...
            <table class="table table-bordered table-striped" id="my_table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td scope="row">{{ $color->firstItem()+$loop->index }}</td>
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                  ...
                                  <li><a class="dropdown-item" href="{{ route('color.edit', $value->id) }}"> <i class="fa-regular fa-pen-to-square"></i> Edit</a></li>
                                  <li>
