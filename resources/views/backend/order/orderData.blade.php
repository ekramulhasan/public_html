            ...
            <table class="table table-bordered table-striped" id="my_table">
                ...
                @forelse ($order as $value)
                    ...
                    <tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="mt-5">
                                                                    <td colspan="50">
                                                                        ...
                                                                        <p>Upazila: {{ $value->billing->upazila->upazila_name_en ?? ''}} ,
                                                                        Distrcit: {{ $value->billing->district->district_name_en ?? ''}}</p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                        ...
                        <td><a href="{{ route('admin.invoice',[$value->id]) }}" class="btn btn-primary">view</a></td>
